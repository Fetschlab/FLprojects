...
def main():
    ...
    # TODO move filepath into main function arguments?
    ...
    # - empirical data, saved as csv file (replace with local file)
    ...
    # *** NOTE this is what you would use to "hand-check" init_params (i.e. skip optimization)
...
# saves sim outputs to disk
sim_outputs = generate_sim_data(
    conds_dict=conds,
