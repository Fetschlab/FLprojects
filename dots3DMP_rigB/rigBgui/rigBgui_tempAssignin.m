...
assignin('base','paradigm',handles.paradigm.String{handles.paradigm.Value});
assignin('base','subject',handles.subject.String{handles.subject.Value});
str = 'load([''/home/fetschlab/PLDAPSFL/settingsStruct_'' paradigm ''_'' subject ''.mat'']);';
evalin('base',str);
...
str = 'load([''/home/fetschlab/PLDAPSFL/settingsStruct_'' paradigm ''_'' subject ''.mat'']);';
evalin('base',str);
str = 'eval([''p = pldaps(@'' paradigm ''_setup, '''''' subject '''''', settingsStruct);''])';
evalin('base',str);
evalin('base','p.run');
...
assignin('base','settingsStruct.pldaps.pass',get(hObject,'Value'));
...
handles.settingsStruct.pldaps.pass = str2double(get(hObject,'String'));
guidata(hObject, handles);
